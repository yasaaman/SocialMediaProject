...
class PostDetailView(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        return render(request, 'home/detail.html', {'post': self.post_instance, 'comments': comments,
                                                    'form': self.form_class, 'reply': self.form_class_reply})
...
class PostUpdateView(LoginRequiredMixin, View):
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        if post.user.id != request.user.id:
            messages.error(request, 'You do not have permission to edit this post!', 'danger')
            return redirect('home:home')
...
class PostAddReplyView(LoginRequiredMixin, View):
    ...
    def post(self, request, post_id, comment_id):
        ...
        if form.is_valid():
            ...
            reply.is_reply = True
            reply.save()
            messages.success(request, 'Reply Commited Successfully', 'success')
        return redirect('home:post_detail', post.id, post.slug)
